          ...
          <MDBDropdown class="nav-item" v-model="dropdown1">
            ...
            <MDBDropdownMenu aria-labelledby="dropdownMenuButton">
              <MDBDropdownItem to="/security"
                >ALzawahed For Services<br />& Security Guards</MDBDropdownItem
              >
              <MDBDropdownItem to="/logistics"
                >ALzawahed For Freight<br />& Logistics</MDBDropdownItem
              >
              <MDBDropdownItem to="/it">ALzawahed IT Solutions</MDBDropdownItem>
              <MDBDropdownItem to="/clearance"
                >ALzawahed For Customs<br />Clearance</MDBDropdownItem
              >
              <MDBDropdownItem to="/contarcting"
                >ALzawahed For Contarcting</MDBDropdownItem
              >
            </MDBDropdownMenu>
          </MDBDropdown>
        </MDBNavbarItem>
        <MDBNavbarItem class="fw text-center" to="/contact"
          >CONTACT</MDBNavbarItem
        >
        <!-- Lang Dropdown -->
